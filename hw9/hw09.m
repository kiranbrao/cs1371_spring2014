%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name         : <Kiran Rao>
% GT Email     : <kiranbrao@gatech.edu>
% Homework     : hw09
% Course       : CS1371
% Instructor   : Omojokun, Smith
% Lecture Time : MWF <11:00>
% TA's Name    : <Emily Croft, Ryan Williams>
% Section      : <A06>
...
% Inputs  (1): -(cell)   Cell array containing various class objects.
...
%
%   Given a cell array, convert the cell array into a structure that
%   contains a field for each class of object that appears in the cell
%   array (with the field name being the class of that entry, all lower
%   case).  The order of the fields in the structure should depend on the
%   order the classes of objects occur in the cell array (i.e. if the first
%   element of the cell array is of type char, then the first field in the
%   structure will be char).  The different class types found in the cell
%   array should all be stored in one cell in the actual structure (so that
%   a field of the structure may be {true, [false, true], false} if three
%   separate logical elements were found in the cell array).  There will
%   not be any structures in the cell arrays, and if a certain class type
%   does not appear in the cell array, its corresponding field should not
%   be created.
%
%   Note:
...
%	 
%==========================================================================
% PROBLEM 2.  What? Evee Is Evolving!
%--------------------------------------------------------------------------
%
